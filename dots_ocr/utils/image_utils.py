...
import os
from dots_ocr.utils.consts import IMAGE_FACTOR, MIN_PIXELS, MAX_PIXELS, ABSOLUTE_MAX_PIXELS
...
def fetch_image(
    ...
    if resized_height and resized_width:
    ...
    elif min_pixels is not None or max_pixels is not None:
        ...
        if max_pixels is None:
            ...
            max_pixels = ABSOLUTE_MAX_PIXELS
        else:
            max_pixels = min(max_pixels, ABSOLUTE_MAX_PIXELS)
        resized_height, resized_width = smart_resize(
            height,
            width,
            factor=IMAGE_FACTOR,
