...
文档设计和评审可立即开始。七天观察期从 v0.3.1 Release 发布时间
2026-07-26 14:51:07+08:00 起算；代码实施不早于
2026-08-02 14:51:07+08:00，且必须满足完整七天内未出现新的 P0/P1 稳定性缺陷，
并且 v0.3.1 长时间、多周期验证已经按记录的风险接受完成评审。任何未关闭的数据
丢失、重复 claim、migration、replay、shutdown 或资源泄漏问题继续作为 v0.3
维护优先项。
